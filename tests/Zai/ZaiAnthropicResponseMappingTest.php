...
final class ZaiAnthropicResponseMappingTest extends AbstractZaiSurfaceResponseMappingTestCase
{
    ...
    {
        return HttpResponseFactory::anthropicStreamStart('msg_sw', 1, 1)
    ...
    public function testAStreamedExplicitNullStopReasonAggregatesAsANaturalStop()
    {
         ...
         */
        $stream = HttpResponseFactory::anthropicStreamStart('msg_null_stop_stream', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAStreamedExplicitNullStopReasonWithToolUseBlocksStillRejects()
    {
        ...
        $stream = HttpResponseFactory::anthropicStreamStart('msg_null_stop_tools_s', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAStreamedNonStringStopReasonStillFailsTyped()
    {
        ...
        // same shape (GLM2 #5).
        $stream = HttpResponseFactory::anthropicStreamStart('msg_bad_stop_s', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAnOutOfOrderContentBlockStopInvalidatesTheStream()
    {
         ...
         * generation).
         */
        $stream = HttpResponseFactory::anthropicStreamStart('msg_interleave', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testASerializedMultiBlockStreamStillAggregates()
    {
         ...
         * in order.
         */
        $stream = HttpResponseFactory::anthropicStreamStart('msg_serial', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":"first"}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"!"}}' . "\n\n"
    ...
    public function testAGenuinelyTruncatedStreamWithTheHeaderKeepsTheStreamTypedError()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_cut', 1, 1);
    ...
    public function provideIgnoredFieldStreamLeads()
    {
        return array(
            ...
            // (the narrowed charlist misrouted such streams to the JSON
            // parser).
    ...
    {
        $body = HttpResponseFactory::anthropicStreamStart('msg_nsi', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    {
        $body = HttpResponseFactory::anthropicStreamStart('msg_nsn', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAStreamedNullToolUseIdKeepsItsParseTimeRejection()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_nul', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testStreamedNegativeZeroToolArgumentsStillAggregate()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_nzs', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testStreamedNonReplayableToolArgumentsFailAsAStreamParseError()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_nrs', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testBothMalformedFlagsLatchedReportsTheToolInputDiagnosis()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_both', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testStreamedExactBigToolInputLiteralsReplayAndLossyOnesReject()
    {
         ...
         */
        $exact = HttpResponseFactory::anthropicStreamStart('msg_ex', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testPreDecodedToolInputBoundaryWindowRejects()
    {
         ...
         */
        $lossy = HttpResponseFactory::anthropicStreamStart('msg_ti', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    {
        /*
         * GLM12 #12 (stamp-at-acceptance, this surface): the
         * consolidated-stream call whose exact big literal the
         * aggregator's precise rule accepted returns as a
         * ReplayValidatedFunctionCall, and the turn REPLAYS on the next
         * request without the outbound oracle re-running — the full
         * oracle's conservative walker would reject the exact literal
         * the aggregator accepted, so the stamp keeps one verdict per
         * value (the GLM3 #1 parse/replay agreement).
         */
        $stream = HttpResponseFactory::anthropicStreamStart('msg_rp', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"tool_use","id":"toolu_rp","name":"convert","input":{}}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"input_json_delta","partial_json":"{\"scale\":100000000000000000000}"}}' . "\n\n"
            . HttpResponseFactory::anthropicBlockStop(0)
            . HttpResponseFactory::anthropicStreamEnd('tool_use', 2);
        ...
        $this->assertInstanceOf(\Deicod\WpConnectors\Zai\Support\ReplayValidatedFunctionCall::class, $assistantPart->getFunctionCall(), 'The accepted streamed call carries the replay stamp.');

        $prompt = array(
            new Message(MessageRoleEnum::user(), array(new MessagePart('go'))),
            new Message(MessageRoleEnum::model(), array($assistantPart)),
            new Message(MessageRoleEnum::user(), array(new MessagePart(new WordPress\AiClient\Tools\DTO\FunctionResponse('toolu_rp', 'convert', array('ok' => true))))),
        );

        $this->queueSdkResponse(200, array('Content-Type' => 'application/json'), HttpResponseFactory::anthropicMessagesBody('replayed'));

        $this->assertSame('replayed', $this->model()->generateTextResult($prompt)->toText(), 'The stamped turn replays without the outbound oracle rejecting it.');
    ...
    public function testStreamedEscapeDenseToolInputStillRejectsLossyLiterals()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_dn', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testStreamedNonReplayableInitialToolInputFailsAsAStreamParseError()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_nri', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testMalformedContentBlockIndexesInvalidateTheStream($eventTemplate)
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_ix', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testConflictingDeltasInvalidateTheStream($startBlockJson, $deltaJson)
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_cf', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: ' . $startBlockJson . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: ' . $deltaJson . "\n\n"
    ...
    public function testAStreamedUnmappedOnlyTurnRejects()
    {
        ...
        $body = ''
            ...
            . HttpResponseFactory::anthropicBlockStop(0)
            . HttpResponseFactory::anthropicStreamEnd('end_turn', 1);
    ...
    public function testADuplicateContentBlockStartInvalidatesTheStream()
    {
        ...
        // content.
        $body = HttpResponseFactory::anthropicStreamStart('msg_dup', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testAPositionRejectedStartNeverPollutesTheToolInputChannel()
    {
         ...
         * first-flag message.
         */
        $duplicate = HttpResponseFactory::anthropicStreamStart('msg_od', 1, 1)
            . 'event: content_block_start' . "\n"
        ...
        $gapped = HttpResponseFactory::anthropicStreamStart('msg_og', 1, 1)
            . 'event: content_block_start' . "\n"
        ...
        // WHETHER.
        $in_position = HttpResponseFactory::anthropicStreamStart('msg_ok', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAContradictingEventTypePairInvalidatesTheStream()
    {
        ...
        // chunk missing.
        $body = HttpResponseFactory::anthropicStreamStart('msg_pair', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: ping' . "\n"
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_pair2', 1, 1)
            . 'event: ping' . "\n"
            . 'data: {"type":"ping"}' . "\n\n"
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
    ...
    public function testANonStringPresentTypeMemberInvalidatesTheStream($typeValue)
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_nonstr', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: ping' . "\n"
    ...
    public function testAnErrorDeclarationWithANonStringTypeKeepsTheErrorFlag($typeValue, $label)
    {
        ...
        $beforeTerminal = HttpResponseFactory::anthropicStreamStart('msg_err_nonstr', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAPingWithoutATypeMemberStaysIgnorableMidStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_notype', 1, 1)
            . 'event: ping' . "\n"
            . 'data: {"ts":123}' . "\n\n"
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
    ...
    public function testAbsentOrNullStreamedStartInputsAreRejected($startBlockJson)
    {
        ...
        // non-streaming path.
        $body = HttpResponseFactory::anthropicStreamStart('msg_abs', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testADeltaAfterContentBlockStopInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_as', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testAStopForANeverStartedIndexInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_ns2', 1, 1)
            . HttpResponseFactory::anthropicBlockStop(3)
            . 'event: message_delta' . "\n"
            . 'data: {"type":"message_delta","delta":{"stop_reason":"end_turn"},"usage":{"output_tokens":2}}' . "\n\n";
    ...
    public function testADataEventAfterMessageStopInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
        ...
        $body2 = HttpResponseFactory::anthropicStreamStart('msg_pt2', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testATypeLessPingAfterMessageStopStaysTolerated()
    {
         ...
         * name now routes it.
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt3', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testADoneSentinelAfterMessageStopStaysTolerated()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt4', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testADuplicateMessageStopAfterMessageStopStaysTolerated()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt5', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testAGarbledDuplicateMessageStopAfterMessageStopStillInvalidates()
    {
        ...
        foreach (array('[]', '["lost"]') as $garbled) {
            $body = HttpResponseFactory::anthropicStreamStart('msg_pt6', 1, 1)
                . 'event: content_block_start' . "\n"
                . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
                . 'event: content_block_delta' . "\n"
                . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testADeclaredEventWithADonePayloadAfterMessageStopIsJudgedNotSkipped()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt4b', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testATrailingErrorDeclarationWithADonePayloadSetsTheErrorFlag()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt4c', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testAnUnknownEventAfterMessageStopDoesNotInvalidateTheCompletedGeneration()
    {
         ...
         * invalidate.
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt7', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testAnErrorDeclaredFrameWithAContradictingPayloadAfterMessageStopInvalidates()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt8', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testATrailingErrorEventWithANonObjectPayloadStillSetsTheErrorFlag()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt9', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testATrailingErrorEventWithAnUndecodablePayloadStillSetsTheErrorFlag()
    {
        /*
         * GLM6 #7: the UNDECODABLE half of the sibling case above — a
         * post-message_stop 'event: error' frame whose payload fails
         * JSON decoding hit the undecodable branch, which lacked the
         * terminated guard the object-shape branch got, so the frame set
         * malformed_event and the stream failed as 'malformed event
         * frame' instead of the documented 'error event' message the
         * GLM4 #6 policy (and its own comment) promise.
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt10', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
        ...
        try {
            $this->model()->generateTextResult($this->prompt());
            $this->fail('A trailing error event with an undecodable payload must fail the stream.');
        } catch (WordPress\AiClient\Providers\Http\Exception\ResponseException $e) {
            $this->assertStringContainsString('error event', $e->getMessage());
            $this->assertStringNotContainsString('malformed event frame', $e->getMessage());
        }
    ...
    public function testAPreTerminationErrorEventWithAnUndecodablePayloadSetsTheErrorFlag()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pe1', 1, 1)
            . 'event: error' . "\n"
            . 'data: {"type":"error","error":{"type":"overloaded_error","message":"Overloaded la' . "\n\n";
    ...
    public function testAPreTerminationErrorEventWithANonObjectPayloadSetsTheErrorFlag()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pe2', 1, 1)
            . 'event: error' . "\n"
    ...
    public function testAPreTerminationErrorEventWithAContradictingStringTypeMemberSetsTheErrorFlag()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_pe3', 1, 1)
            . 'event: error' . "\n"
            . 'data: {"type":"ping"}' . "\n\n";
    ...
    public function testATrailingErrorDeclarationWithoutADataLineFailsTheStream()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_gl81a', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testAFinalErrorDeclarationCutBeforeTheBlankLineFailsTheStream()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_gl81b', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testAPreTerminationErrorDeclarationWithoutADataLineSetsTheErrorFlag()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_gl81c', 1, 1)
            . 'event: error' . "\n\n";
    ...
    public function testABareNonErrorDeclarationWithoutADataLineStaysIgnorable()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_gl81d', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
        ...
        $truncated = HttpResponseFactory::anthropicStreamStart('msg_gl81e', 1, 1)
            . 'event: message_delta' . "\n\n";
    ...
    public function testDataLessContentBlockDeclarationsInvalidateTheStream()
    {
         ...
         * frame.
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_g23a', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n\n"
            . 'event: content_block_delta' . "\n"
         ...
         */
        $eof_cut = HttpResponseFactory::anthropicStreamStart('msg_g23b', 1, 1)
            . 'event: content_block_delta' . "\n\n";
         ...
         */
        $split = HttpResponseFactory::anthropicStreamStart('msg_g23c', 1, 1)
            . 'event: content_block_start' . "\n\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n\n"
        ...
        $split_cut = HttpResponseFactory::anthropicStreamStart('msg_g23d', 1, 1)
            . 'event: content_block_delta' . "\n\n"
        ...
        foreach ( array( 'content_block_start', 'content_block_stop' ) as $cut_event ) {
            $cut = HttpResponseFactory::anthropicStreamStart('msg_g23e', 1, 1)
                . 'event: ' . $cut_event . "\n\n"
                . 'event: message_stop' . "\n"
                . 'data: {"type":"message_stop"}' . "\n\n";
    ...
    public function testATypelessDataOnlyCarrierFrameInvalidatesTheStream()
    {
         ...
         * declaring nothing).
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_g33a', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testUndeclaredTypelessFramesKeepTheirTolerances()
    {
         ...
         */
        $scalar = HttpResponseFactory::anthropicStreamStart('msg_g33b', 1, 1)
            . 'data: null' . "\n\n"
            . 'event: content_block_start' . "\n"
        ...
        $trailing = HttpResponseFactory::anthropicStreamStart('msg_g33c', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":"Done."}}' . "\n\n"
            . HttpResponseFactory::anthropicBlockStop(0)
            . HttpResponseFactory::anthropicStreamEnd('end_turn', 2)
    ...
    public function testAnUndecodableDataOnlyFrameInvalidatesTheStream()
    {
         ...
         * skip (glm33-1) intact.
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_g34a', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Hello "}}' . "\n\n"
    ...
    public function testTheContentBlockVocabularyIsOneTableBothSwitchesRide()
    {
        ...
        foreach ( $mapped_fixtures as $type => $fixture ) {
            ...
            $stream = HttpResponseFactory::anthropicStreamStart('msg_vocab_' . $type . '', 1, 1)
                . 'event: content_block_start' . "\n"
        ...
        foreach ( AnthropicContentBlocks::KNOWN_UNMAPPED_TYPES as $unmapped ) {
            $stream = HttpResponseFactory::anthropicStreamStart('msg_vocab_drop_' . $unmapped . '', 1, 1)
                . 'event: content_block_start' . "\n"
    ...
    public function testATrailingUndecodableDeclaredContentEventStillInvalidates()
    {
        ...
        // verdict — any other declared name after message_stop stays the
        // corrupt-mutation rejection, decodable payload or not.
        $body = HttpResponseFactory::anthropicStreamStart('msg_pt11', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
        ...
        try {
            $this->model()->generateTextResult($this->prompt());
            $this->fail('A trailing undecodable declared content event must fail the stream.');
        } catch (WordPress\AiClient\Providers\Http\Exception\ResponseException $e) {
            $this->assertStringContainsString('malformed event frame', $e->getMessage());
        }
    }
    ...
    public function testAStartBlockWithoutAValidTypeInvalidatesTheStream()
    {
        ...
        foreach (array(
            ...
            $body = HttpResponseFactory::anthropicStreamStart('msg_nt', 1, 1)
                . 'event: content_block_start' . "\n"
                . 'data: ' . $startJson . "\n\n"
                . 'event: content_block_delta' . "\n"
                . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"x"}}' . "\n\n"
    ...
    public function testADuplicateMessageDeltaInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_dd', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testAnIdenticalDuplicateMessageDeltaIsAlsoRejected()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_dd2', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"x"}}' . "\n\n"
    ...
    public function testContentEventsAfterMessageDeltaInvalidateTheStream($lateEventFrames)
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_ld', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testContentEventsBeforeMessageDeltaStillAggregate()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_ok3', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Fine."}}' . "\n\n"
    ...
    public function testASecondValidMessageStartInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('first', 11, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Content."}}' . "\n\n"
            . HttpResponseFactory::anthropicStreamStart('second', 99, 1)
            . 'event: message_delta' . "\n"
            . 'data: {"type":"message_delta","delta":{"stop_reason":"end_turn"},"usage":{"output_tokens":2}}' . "\n\n";
    ...
    public function testMalformedInitialTextOrThinkingMembersInvalidateTheStream($startJson)
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_mm', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: ' . $startJson . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testValidInitialTextAndThinkingMembersStillAggregate()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_vm', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testADuplicateToolUseIdInAConsolidatedStreamIsRejected()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_dupstream', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAConsolidatedStreamWithToolUseStopReasonButNoToolBlockIsRejected()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_tust', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testStreamedMessageDeltaInputSideSupersedesTheStartEstimate()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_di2', 3, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Hi."}}' . "\n\n"
    ...
    public function testALegacyDeltaUsageCarryingOnlyOutputKeepsTheStartInput()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_di3', 7, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Hi."}}' . "\n\n"
            . HttpResponseFactory::anthropicBlockStop(0)
            . HttpResponseFactory::anthropicStreamEnd('end_turn', 3);
    ...
    public function testAStreamedDeltaInputSideOverflowInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_di4', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":"x"}}' . "\n\n"
            . HttpResponseFactory::anthropicBlockStop(0)
            . 'event: message_delta' . "\n"
    ...
    public function testAMalformedMessageDeltaUsageInvalidatesTheStream($usageJson)
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_mdu', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"x"}}' . "\n\n"
    ...
    public function testAValidOrAbsentMessageDeltaUsageStillAggregates($usageJson)
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_vdu', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"ok"}}' . "\n\n"
    ...
    public function testStreamWithoutTrailingBlankLineKeepsTheFinalEvent()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_f', 2, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    {
        $body = HttpResponseFactory::anthropicStreamStart('msg_p', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testAggregatedRequiresMessageStopBeforeReturningAPayload()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_tr', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testAllThreeContentEventKindsPassTheSharedGuardsCleanly()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_helper', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"OK."}}' . "\n\n"
    ...
    public function testObjectNessDistinctionsSurviveTheSingleDecode()
    {
        ...
        $startWithInput = static function ( string $input_json ): string {
            return HttpResponseFactory::anthropicStreamStart('msg_on1', 1, 1)
                . 'event: content_block_start' . "\n"
    ...
    public function testNoncontiguousBlockStartsInvalidateTheStream()
    {
        ...
        $bodies = array(
            'first start at index 1 (block 0 lost)' => ''
                . HttpResponseFactory::anthropicStreamStart('msg_g1', 1, 1)
                . 'event: content_block_start' . "\n"
                . 'data: {"type":"content_block_start","index":1,"content_block":{"type":"text","text":""}}' . "\n\n"
                . HttpResponseFactory::anthropicBlockStop(1)
                . HttpResponseFactory::anthropicStreamEnd('end_turn', 2),
    ...
    public function testInOrderContiguousStartsStillAggregate()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_c1', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAStreamTruncatedBeforeMessageStopFails()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_n', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Done."}}' . "\n\n"
    ...
    public function testATruncatedStreamWithoutAStopReasonFailsInTheMalformedChannel()
    {
         ...
         * yields.
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_t', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testACompleteLifecycleLosingOnlyMessageDeltaFlagsTheMalformedChannel()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_t2', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . HttpResponseFactory::anthropicBlockStop(0)
            . 'event: message_stop' . "\n"
    ...
    public function testAMessageDeltaWithoutAnObjectDeltaMemberIsRejectedTyped($deltaFragment, $label)
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_md', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . HttpResponseFactory::anthropicBlockStop(0)
            . 'event: message_delta' . "\n"
...
$body = ''
    ...
    public function testAScalarStartBlockToolInputFailsAsAStreamParseError()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_sb', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAListStartBlockToolInputFailsAsAStreamParseError()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_sb2', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: ' . $list_start . "\n\n"
            . HttpResponseFactory::anthropicBlockStop(0)
            . HttpResponseFactory::anthropicStreamEnd('tool_use', 2);
    ...
    public function testAnEmptyJsonListStartBlockToolInputFailsAsAStreamParseError()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_sb3', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAnEmptyObjectStartBlockInputStaysANoArgumentCall()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_sb4', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAnObjectStartBlockInputWithoutDeltasBecomesTheCallArgs()
    {
        ...
        // call's arguments.
        $body = HttpResponseFactory::anthropicStreamStart('msg_sb5', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testATopLevelNumericKeyedStartBlockInputStaysAnObject()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_sb6', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testANullPartialJsonDeltaFailsAsAStreamParseError()
    {
        ...
        // no-argument call.
        $body = HttpResponseFactory::anthropicStreamStart('msg_np', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAMissingPartialJsonDeltaFailsAsAStreamParseError()
    {
        ...
        // shape as null.
        $body = HttpResponseFactory::anthropicStreamStart('msg_mp', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAnEmptyStringPartialJsonDeltaStaysANoOp()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_ep', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testFragmentsOverANonEmptyStartInputFailAsAStreamParseError()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_glm312', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testANonStringPartialJsonDeltaFailsAsAStreamParseError()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_npd', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAMalformedUnknownEventFrameStaysIgnorable()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_ue', 1, 1)
    ...
    {
        $body = HttpResponseFactory::anthropicStreamStart('msg_pg', 1, 1)
            . 'event: ping' . "\n"
    ...
    public function testAListPayloadForADeclaredEventInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_lp', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: ["lost chunk"]' . "\n\n"
    ...
    public function testAWrongShapeTypedDataOnlyFrameInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_do', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
    ...
    public function testAGarbageContentBlockStartInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_gb', 1, 1)
            . 'event: content_block_start' . "\n"
    ...
    public function testAToolDeltaWithoutAStartBlockInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_ns', 1, 1)
            . 'event: content_block_delta' . "\n"
    ...
    public function testATextDeltaWithoutAStartBlockInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_ts', 1, 1)
            . 'event: content_block_delta' . "\n"
    ...
    public function testAThinkingDeltaWithoutAStartBlockInvalidatesTheStream()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_tsn', 1, 1)
            . 'event: content_block_delta' . "\n"
    ...
    public function testAFinalDeltaWithAnUnclosedBlockInvalidatesTheStream()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_ob', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
            . 'data: {"type":"content_block_delta","index":0,"delta":{"type":"text_delta","text":"Truncated."}}' . "\n\n"
    ...
    public function testFullyStoppedMultiBlockStreamsStillAggregate()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_mb', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . 'event: content_block_delta' . "\n"
    ...
    public function testAStreamWithOneOpenBlockAmongStoppedOnesInvalidates()
    {
        ...
        $body = HttpResponseFactory::anthropicStreamStart('msg_ob2', 1, 1)
            . 'event: content_block_start' . "\n"
            . 'data: {"type":"content_block_start","index":0,"content_block":{"type":"text","text":""}}' . "\n\n"
            . HttpResponseFactory::anthropicBlockStop(0)
            . 'event: content_block_start' . "\n"
    ...
    public function testAnUnknownDeltaOnAnUnseenIndexInvalidatesTheStream()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_us', 1, 1)
            . 'event: content_block_delta' . "\n"
    ...
    public function testADamagedStreamWhoseOnlyDeltaIsUnknownNeverFabricatesContent()
    {
         ...
         */
        $body = HttpResponseFactory::anthropicStreamStart('msg_fr', 1, 1)
            . 'event: content_block_delta' . "\n"
    ...
    public function testAnAllMalformedStreamFailsSafely()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('Unexpected zai_anthropic API response', $e->getMessage());
    ...
    {
        $body = HttpResponseFactory::anthropicStreamStart('msg_u', 1, 1)
            . 'event: some_future_event' . "\n"
    ...
    private function corePromptBuilder()
    {
        ...
        // fact.
        return $this->bootedCorePromptBuilder(ZaiAnthropicProvider::class, HttpResponseFactory::anthropicModelsBody(array('glm-5.3')));
    }
